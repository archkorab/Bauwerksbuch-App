...
export function StatusBadge({ status }: { status: string }) {
  ...
  if (status === "active" || status === "OK") {
    colorClass = "bg-emerald-500/15 text-emerald-600 border border-emerald-500/30";
  } else if (status === "needs_repair") {
    colorClass = "bg-amber-500/15 text-amber-600 border border-amber-500/30";
  } else if (status === "urgent") {
    colorClass = "bg-destructive/15 text-destructive border border-destructive/30";
  } else if (status === "completed") {
    colorClass = "bg-indigo-500/15 text-indigo-600 border border-indigo-500/30";
  }
